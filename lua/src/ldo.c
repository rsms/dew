...
// #include "../../wasm.h"
extern void* _Nullable wlongjmp_scope(void(^try_block)());
extern __attribute__((noreturn)) void wlongjmp(void* _Nullable retval);

#define LUAI_THROW(L,c)   wlongjmp(NULL)
#define LUAI_TRY(L,c,a)   wlongjmp_scope(^{ a })
#define luai_jmpbuf  int  /* dummy variable */
